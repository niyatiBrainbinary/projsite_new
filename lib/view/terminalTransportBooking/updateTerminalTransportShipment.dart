...
class _UpdateTerminalTransportShipmentState extends State<UpdateTerminalTransportShipment> {
                    ...
                    child: BlocConsumer<CalendarCubit,CalendarState>(
                      listener: (context, state) {
                        if(state is RequestDataSuccess){
                          ...
                          _itemName.text=calendarCub.requestData!.result!.imageName;
                          _palletCon.text=calendarCub.requestData!.result!.noOfPallet;
